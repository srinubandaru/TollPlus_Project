...
public class ExcelFileUtil 
{
   ...
   FileInputStream fis = new FileInputStream("./TestInputs/InputSheet.xlsx");
	...
	//	FileInputStream fis = new FileInputStream(PropertyFileUtil.getValueForKey("InputSheet.xlsx"));
	...
	FileOutputStream fos = new FileOutputStream("./TestOutput/OutputSheet.xlsx");
		...
		//FileOutputStream fos = new FileOutputStream(PropertyFileUtil.getValueForKey("OutputSheet.xlsx"));
